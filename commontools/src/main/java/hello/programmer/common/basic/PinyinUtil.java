...
public class PinyinUtil {
	...
	public static List<String> findpy2(String charcode){
		if(charcode == null || charcode.length()==0){
	...
	/**
	 * 获取汉字的拼音，left全拼 right简拼
	 * 不是特别准确，多音字取第一个
	 * @param str
	 * @return
	 */
	public static Combo2<String,String> dealHzPy(String str){
		String[] strarry = str.split("");
		StringBuilder sd1 = new StringBuilder();
		StringBuilder sd2 = new StringBuilder();
		List<String> pyqp = new ArrayList<>();//拼音全拼
		List<String> pyjp = new ArrayList<>();//拼音简拼
		for(int i=0; i<strarry.length; i++){
			String dealresult = findpy(strarry[i]);
			if(dealresult != null && !"".equals(dealresult)){
				pyqp.add(dealresult);
				pyjp.add(dealresult.substring(0,1));
			}
		}
		for(String s1: pyqp){
			sd1.append(s1).append(" ");
		}
		for(String s2: pyjp){
			sd2.append(s2);
		}
		return new Combo2<>(sd1.toString() , sd2.toString());
	}
